...
namespace pocgen.Contracts.Models
{
    ...
    {
        public FieldFiller(IMarkdownGenerator markdownGenerator)
        {
        ...
        public void FillFieldWithInfo(Field field, Slide correspondingSlide, ICourseInfo courseInfo)
        {
            ...
            {
                case ("Überschrift"):
                    string title = (correspondingSlide.Shapes.HasTitle == Microsoft.Office.Core.MsoTriState.msoTrue)
                    ...
                    break;
                case ("Inhalt"):
                    string slidetitle = (correspondingSlide.Shapes.HasTitle == Microsoft.Office.Core.MsoTriState.msoTrue)
                        ? correspondingSlide.Shapes.Title.TextFrame.TextRange.Text : string.Empty;
                    ...
                    {
                        if (correspondingSlide.Shapes[i].HasTextFrame == Microsoft.Office.Core.MsoTriState.msoTrue &&
                            correspondingSlide.Shapes[i].TextFrame.HasText == Microsoft.Office.Core.MsoTriState.msoTrue &&
                ...
                case ("Notiz"):
                    ...
                    if (!string.IsNullOrWhiteSpace(notesInSlide)) // Wenn Notizen vorhanden sind -> Notizen ausgeben
                    {
                        ...
                        markdownGenerator.GenerateMarkdownFromInputAndCopyIntoClipboard(notesInSlide);
                        field.Result.Paste();
